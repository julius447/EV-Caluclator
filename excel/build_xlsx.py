...
CHARGERS = (
    ...
    [
        ...
        ["zaptec-go",            "Zaptec Go",            "Kompakt, upp till 22 kW",        "Bästsäljare",      22,  4490,  8980, "false", "https://ampy.se/laddboxar/zaptec-go/",                "true",  1],
        ["zaptec-go-2",          "Zaptec Go 2",          "Nu med inbyggd skärm",        "Rekommenderas",    22,  5890, 11780, "false", "https://ampy.se/laddboxar/zaptec-go-2/",              "true",  2],
        ["easee-charge-up",      "Easee Charge Up",      "Smart laddning via app",           "Bästsäljare",      22,  4390,  8780, "false", "https://ampy.se/laddboxar/easee-charge-up/",          "true",  3],
        ["nexblue-edge-2",       "NexBlue Edge 2",       "Prisbelönt design",      "Prisvärd",         22,  4190,  8380, "false", "https://ampy.se/laddboxar/nexblue-edge-2/",           "true",  4],
        ["go-e-gemini-flex-2-0", "go-e Gemini Flex 2.0", "Fast eller flyttbar",    "",                 22,  4990,  9980, "false", "https://ampy.se/laddboxar/go-e-gemini-flex-2-0/",     "true",  5],
        ["tesla-wall-connector", "Tesla Wall Connector", "Fast kabel, 7,3 m",       "",                 11,  4450,  8900, "false", "https://ampy.se/laddboxar/tesla-wall-connector/",     "true",  6],
        ["charge-amps-luna",     "Charge Amps Luna",     "Skandinavisk design",    "",                 22,  4850,  9700, "false", "https://ampy.se/laddboxar/charge-amps-luna/",         "true",  7],
        ["charge-amps-halo",     "Charge Amps Halo",     "Fast kabel & statusljus","",                 22,  4990,  9980, "false", "https://ampy.se/laddboxar/charge-amps-halo/",         "true",  8],
        ["charge-amps-dawn",     "Charge Amps Dawn",     "Svensktillverkad premium","",                22,  6850, 13700, "false", "https://ampy.se/laddboxar/charge-amps-dawn/",         "true",  9],
        ["charge-amps-aura",     "Charge Amps Aura",     "Två bilar samtidigt",    "Dubbel laddning",  22, 14550, 29100, "false", "https://ampy.se/laddboxar/charge-amps-aura/",         "true", 10],
        ["defa-power",           "Defa Power",           "Display, klarar −40 °C",        "",                 22,  5250, 10500, "false", "https://ampy.se/laddboxar/defa-power/",               "true", 11],
        ["amina-s",              "Amina S",              "Marknadens minsta",      "",                 11,  4350,  8700, "false", "https://ampy.se/laddboxar/amina-s/",                  "true", 12],
        ["garo-entity-home",     "Garo Entity Home",     "Driftsäker villabox",    "",                 22,  5310, 10620, "false", "https://ampy.se/laddboxar/garo-entity-home/",         "true", 13],
        ["wallbox-pulsar-max",   "Wallbox Pulsar Max",   "Prisbelönt & kompakt",   "",                 22,  4425,  8850, "false", "https://ampy.se/laddboxar/wallbox-pulsar-max/",       "true", 14],
        ["zaptec-pro",           "Zaptec Pro",           "Skalbar för flera platser",          "Offert",           22,    "",    "", "true",  "https://ampy.se/laddboxar/zaptec-pro/",               "true", 15],
...
PRICEAREAS = (
    ...
    [
        ["SE1", "SE1 – Norra Sverige",       1.10, 0.60, "false"],
        ["SE2", "SE2 – Norra Mellansverige", 1.15, 0.65, "false"],
        ["SE3", "SE3 – Södra Mellansverige", 1.60, 0.90, "true"],
        ["SE4", "SE4 – Södra Sverige",       1.80, 1.00, "false"],
    ],
)
